  				...
  				<div class="col-md-6">
  					<div id="order-preview">
		    			...
		    			<div id="order-not-confirm" class="col-md-12">
								<span>
									<span class="pull-right" id="process-link"><a class="a-link"  href="javascript:app.order.process()">confirmer</a> </span>
								...
								<form id = "paypal_checkout" action = "https://www.sandbox.paypal.com/cgi-bin/webscr" method = "post">
								    ...
								    <input name = "return" value = "http://localhost:8888/210/views/payment.php" type = "hidden">
								    <input name = "cbt" value = "Return to My Site" type = "hidden">
								    <input name = "cancel_return" value = "http://localhost:8888/210/index.php" type = "hidden">
